...
import Link from "next/link" // Corrige a importação do Link
    ...
    <nav className="h-16 bg-gray-900 text-white flex items-center justify-between px-4 border-b border-gray-800 sticky top-0 z-50">
      <div className="flex items-center">
        ...
        <div className="flex items-center mr-4">
          ...
          <Link
            href="/landing"
            className="ml-4 text-sm font-medium hover:underline hidden md:inline-block"
          >
            Landing
          </Link>
        </div>
        ...
        <div className="relative hidden md:block">
          <Input
            placeholder="Search..."
            className="w-64 bg-gray-800 border-gray-700 focus-visible:ring-indigo-500"
          />
