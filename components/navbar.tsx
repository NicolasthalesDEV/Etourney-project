...
=======
import { Search, Bell, Settings, User, Menu, Link } from "lucide-react"
>>>>>>> 7fe8abb (Deploying final version with become a investor)
...
<Link href="/landing" className="ml-4 text-sm font-medium hover:underline hidden md:inline-block">
  Landing
</Link>
>>>>>>> 7fe8abb (Deploying final version with become a investor)
        </div>
